...
// https://github.com/TsudaKageyu/minhook/blob/master/src/hde/hde32.h
...
DWORD unprotect(DWORD func_addr) {
	BYTE* funcaddr = (BYTE*)func_addr;
...
BYTE* get_func_end(BYTE* funcaddr) {
	BYTE* addr = funcaddr;
	do {
		addr += 0x10;
