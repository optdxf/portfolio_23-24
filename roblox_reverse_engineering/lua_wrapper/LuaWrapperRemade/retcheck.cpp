...
DWORD RetCheck::GetFunctionSize(DWORD Address) {
...
bool RetCheck::IsFunction(DWORD Address) {
...
bool RetCheck::DisableRetcheck(DWORD NewFunction, DWORD FunctionSize) {
...
void RetCheck::FixCalls(DWORD OriginalFunction, DWORD NewFunction, DWORD FunctionSize) {
	BYTE *Address = (BYTE*)NewFunction;
...
DWORD RetCheck::Unprotect(DWORD Address) {
